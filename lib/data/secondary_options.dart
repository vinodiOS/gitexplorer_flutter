const secondaryOptions = {
  ...
  'show': [
    ...
    {'value': 'logs', 'label': 'commit logs/history'},
    {
    ...
    {'value': 'stash', 'label': 'stash', 'usage': 'git stash list'},
    {
      'value': 'branch',
      'label': 'branches',
      'usage': 'git branch',
    ...
    {'value': 'tags', 'label': 'tags', 'usage': 'git tag'}
  ],
  'delete': [
    {
      'value': 'branch',
    ...
    {'value': 'tag', 'label': 'a tag', 'usage': 'git tag -d v<tag version>'},
    {'value': 'remote', 'label': 'remote', 'usage': 'git remote rm <remote>'},
    {
  ...
  'add': [
    ...
    {'value': 'add-new-branch', 'label': 'a new branch'},
    {
      'value': 'add-repo',
  ...
  'rename': [
    ...
    {'value': 'file', 'label': 'file', 'usage': 'git mv file_from file_to'},
    {
      'value': 'remoteUrl',
      'label': 'remote',
  ...
  'stash': [
    ...
    {'value': 'delete-stash', 'label': 'delete'},
    {
      'value': 'create-branch',
